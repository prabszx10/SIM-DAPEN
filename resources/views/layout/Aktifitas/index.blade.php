    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title">Detail Dokumen <span id="modal_title"></span></h3>
          </div>
...
<div class="modal fade bd-example-modal-lg" id="detail_modal_revisi" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title">Revisi Dokumen <span id="modal_title"></span></h3>
          </div>
          <div class="modal-body">
            <form action="javascript:onUpdate()" id="formDataSecondary" method="POST" autocomplete="off">
                <div class="card-body py-3 mt-3">
                    @csrf
                    <input type="hidden" name="revisi_aktifitas_id" placeholder="" value="" />
                    <div class="row">
                        <div class="col-12">
                            <div class="form-floating mb-7">
                                <input type="text" class="form-control form-control-solid" name="revisi_aktifitas_nama"
                                    placeholder="" value="" required />
                                <label for="floatingInput"><span class="required">Nama Aktifitas</span></label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div id="list_dokumen_aktifitas_revisi"></div>
                        </div>
                    </div>
