<div class="card shadow-sm form_data" style="display:none">
    ...
    <form action="javascript:onSaveRole()" id="formData" method="POST" autocomplete="off">
        <div class="card-body py-3 mt-3">

            @csrf
            <input type="hidden" name="role_id" placeholder="" value="" />
            <div class="form-floating mb-7">
                <input type="text" class="form-control form-control-solid" name="role_name"
                    placeholder="Nama Hak Akses" value="" required />
                <label for="floatingInput"><span class="required">Nama Hak Akses</span></label>
            </div>
